  ...
  describe('returnDetails() reducer', () => {
    ...
    it.each([
      ...
      expect(
        reducer(undefined, {
          meta: { returnId },
          type: actionType,
          payload: { error: new Error('dummy error') as BlackoutError },
        }).returnDetails,
      ).toEqual({
    ...
    describe('should handle RESET_RETURN_STATE action type', () => {
      ...
      const state = {
        ...
        returnDetails: {
          error: {
            [returnId]: new Error('dummy_error') as BlackoutError,
            [anotherReturnId]: new Error('dummy_error') as BlackoutError,
          },
  ...
  describe('returnPickupCapability() reducer', () => {
    ...
    describe('should handle RESET_RETURN_PICKUP_CAPABILITY_STATE action type', () => {
      ...
      const state = {
        ...
        returnPickupCapabilities: {
          error: {
            [returnPickupCapabilityId]: new Error(
              'dummy_error',
            ) as BlackoutError,
            [anotherReturnPickupCapabilityId]: new Error(
              'dummy_error',
            ) as BlackoutError,
          },
          isLoading: {
  ...
  describe('createReturn() reducer', () => {
    ...
    it('should handle RESET_CREATE_RETURN_STATE action type', () => {
      const state = {
        ...mockState.returns,
        createReturn: {
          error: new Error('dummy_error') as BlackoutError,
          isLoading: true,
        },
      };
